...
import mk.finki.ukim.mk.lab.repositoryJPA.BalloonRepository;
...
public class SaveBalloonTest {
    ...
    public void init() {
        ...
        Manufacturer manufacturer = new Manufacturer("BirthdayBalloons", "Skopje 1000");
    ...
    public void testSuccessAdd() {
        ...
        Manufacturer manufacturer = this.manufacturerService.save("BirthdayBalloons", "Skopje 1000");
        Balloon balloon = this.balloonService.save("Red Balloon", "This is red balloon", null
                    ,manufacturer ,Type.Arrow).get();

        Mockito.verify(this.manufacturerService).save("BirthdayBalloons", "Skopje 1000");
        ...
        Assert.assertEquals("balloon manufacturer do not mach", "BirthdayBalloons", balloon.getManufacturer().getName());
    }
